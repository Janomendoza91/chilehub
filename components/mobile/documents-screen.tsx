...
export function DocumentsScreen() {
  return (
    ...
    >
      <div className="flex h-full flex-col bg-white px-3 pb-2.5 pt-3 sm:px-5 sm:pb-4 sm:pt-4">
        ...
        <div className="mt-4 flex items-center justify-between sm:mt-6">
          ...
          <h3 className="text-[10.5px] font-extrabold text-[#081642] sm:text-[12px]">
            Paso a paso
          </h3>
        ...
        <div className="mt-4 flex items-center justify-between sm:mt-7">
          {[1, 2, 3, 4, 5, 6].map((step) => (
            <div
              key={step}
              className={`grid h-4 w-4 place-items-center rounded-full text-[8px] font-bold sm:h-5 sm:w-5 sm:text-[9px] ${step === 2 ? "bg-primary text-white" : step < 2 ? "bg-[#eaf0ff] text-primary" : "bg-[#eef2f8] text-[#8b96ae]"}`}
            >
              {step}
            </div>
          ))}
        ...
        <h3 className="mt-2 text-[15px] font-extrabold tracking-[-0.02em] text-[#081642] sm:mt-3 sm:text-[18px]">
          Firma del contrato
        </h3>
        <p className="mt-2 text-[9px] leading-3 text-[#6f7a96] sm:mt-4 sm:text-[11px] sm:leading-5">
          Firma el contrato de compraventa con datos correctos.
        </p>
        <div className="mt-4 rounded-[11px] border border-[#e4e9f2] bg-white p-2.5 sm:mt-7 sm:rounded-[12px] sm:p-4">
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            <div className="min-w-0">
              <h4 className="text-[9.5px] font-extrabold text-[#081642] sm:text-[11px]">
                Contrato de compraventa
              </h4>
              <p className="mt-0.5 text-[8.5px] text-[#7a85a0] sm:mt-1 sm:text-[10px]">
                Formato oficial.
              </p>
            </div>
          </div>
        ...
        <div className="mt-4 sm:mt-8">
          <h4 className="text-[10.5px] font-extrabold text-[#081642] sm:text-[12px]">
            Consejo util
          </h4>
          <div className="mt-2 rounded-[10px] bg-[#f7fbff] p-2.5 text-[8.5px] leading-3 text-[#6f7a96] sm:mt-4 sm:rounded-[12px] sm:p-4 sm:text-[10px] sm:leading-4">
