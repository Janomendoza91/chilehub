...
export function ProgressScreen() {
  return (
    ...
    >
      <div className="flex h-full flex-col bg-white px-3 pb-2.5 pt-3 transition-colors dark:bg-[#0b1120] sm:px-4 sm:pb-3 sm:pt-4">
        ...
        <div className="mt-3 flex items-center gap-2 sm:mt-4">
          <button className="text-[#6d7895] dark:text-[#aeb9d4]" aria-label="Volver">
        ...
        <div className="mt-3 rounded-[12px] bg-[#f7f9ff] p-2.5 dark:bg-[#111a31] sm:mt-4 sm:p-3">
          ...
          <div className="mt-3 rounded-[10px] border border-[#e6ebf4] bg-white p-2 dark:border-white/10 dark:bg-white/[0.08]">
            <p className="text-[8.5px] font-bold text-[#6b7692] dark:text-[#9aa8c7] sm:text-[10px]">
              Paso actual
            </p>
            <h4 className="mt-0.5 text-[11px] font-extrabold text-[#081642] dark:text-white sm:text-[12px]">
              Reune documentos
            </h4>
          </div>
        </div>
        ...
        <div className="mt-3 sm:mt-4">
          <h4 className="text-[10.5px] font-extrabold text-[#081642] dark:text-white sm:text-[11.5px]">
