...
export function CompletedScreen() {
  return (
    ...
    >
      <div className="relative flex h-full flex-col bg-white px-3 pb-2.5 pt-3 text-center sm:px-5 sm:pb-3 sm:pt-4">
        <div className="flex w-full items-center justify-between text-[10px] font-bold text-[#111936]">
          <span>9:41</span>
          <span>•••</span>
        </div>
        ...
        <h3 className="mt-5 text-[16px] font-extrabold tracking-[-0.02em] text-[#081642] sm:mt-7 sm:text-[19px]">
          Tramite completado
        </h3>
        <p className="mx-auto mt-1.5 max-w-[135px] text-[9px] leading-3 text-[#6f7a96] sm:mt-2 sm:max-w-[155px] sm:text-[10.5px] sm:leading-4">
          Ya tienes la preparacion lista para vender tu auto.
        </p>

        <div className="mt-5 rounded-[12px] border border-[#e4eaf5] bg-[#fbfcff] p-2.5 text-left sm:mt-7 sm:rounded-[14px] sm:p-3">
          <div className="flex items-center gap-2">
            ...
            <div>
              ...
              <p className="mt-0.5 text-[8.5px] leading-3 text-[#7a85a0] sm:text-[9.5px] sm:leading-4">
                Continua en Registro Civil para transferir el vehiculo.
              </p>
            </div>
          </div>
          <button className="mt-2.5 flex h-8 w-full items-center justify-center gap-1 rounded-[8px] border border-[#dfe5f3] bg-white text-[9.5px] font-bold text-primary sm:mt-3 sm:h-9 sm:text-[10.5px]">
