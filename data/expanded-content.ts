...
import { nationalProcedureSeeds } from "@/data/national-procedure-seeds";
...
const additionalProcedureSeeds: ProcedureSeed[] = [
  ...
  // Impuestos
  { slug: "emitir-boleta-honorarios-servicios", title: "Emitir boleta de honorarios por servicios", category: "Impuestos", summary: "Prepara datos del receptor, monto y retencion antes de emitir boleta.", cost: "$0 directo; retencion segun normativa.", duration: "5 a 15 minutos.", channel: "SII", documents: ["Clave SII", "Datos receptor", "Monto"], sources: [sii] },
  { slug: "corregir-boleta-honorarios", title: "Corregir o anular boleta de honorarios", category: "Impuestos", summary: "Revisa plazo, motivo y aceptacion antes de anular o corregir una boleta.", cost: "$0 directo.", duration: "Minutos a dias segun caso.", channel: "SII", documents: ["Folio boleta", "Motivo", "Datos receptor"], sources: [sii] },
  { slug: "emitir-factura-electronica-empresa", title: "Emitir factura electronica para empresa", category: "Impuestos", summary: "Prepara folios, receptor, giro y detalle antes de emitir una factura.", cost: "$0 a software variable.", duration: "5 a 20 minutos.", channel: "SII o software autorizado", documents: ["Clave SII", "Datos cliente", "Detalle venta"], sources: [sii] },
  ...
  { slug: "preparar-viaje-con-mascota-exterior", title: "Preparar viaje con mascota al exterior", category: "Viajes", summary: "Ordena vacunas, certificado sanitario y requisitos del pais antes de viajar.", cost: "$20.000 a $300.000+ aprox.", duration: "Semanas a meses.", channel: "SAG, veterinario y aerolinea", documents: ["Carnet vacunas", "Certificado veterinario", "Datos mascota"], sources: [chileAtiende] },
  { slug: "pasaporte-viaje-proximo", title: "Preparar renovacion urgente de pasaporte", category: "Viajes", summary: "Revisa agenda, documentos y alternativas cuando tienes viaje cercano.", cost: "$70.000 a $100.000+ aprox.", duration: "Dias segun disponibilidad.", channel: "Registro Civil", documents: ["Cedula", "Pasaporte anterior", "Comprobante viaje si aplica"], sources: [registroCivil, chileAtiende] },
  ...
  { slug: "documentos-perdidos-extranjero", title: "Que preparar si pierdes documentos fuera de Chile", category: "Viajes", summary: "Ordena denuncia, consulado y copias para enfrentar perdida de documentos en viaje.", cost: "Variable segun consulado y documentos.", duration: "Dias segun pais.", channel: "Consulado de Chile y autoridades locales", documents: ["Denuncia", "Copia documento", "Itinerario"], sources: [chileAtiende] },
  { slug: "certificado-vacunas-internacional", title: "Certificado de vacunas internacional", category: "Viajes", summary: "Revisa vacunas, destino y formato exigido antes de salir del pais.", cost: "$0 a costos medicos variables.", duration: "Dias a semanas.", channel: "MINSAL, vacunatorio o prestador", documents: ["RUN", "Registro vacunas", "Destino"], sources: [chileAtiende] },
  ...
  // Documentos
  { slug: "certificado-matrimonio-para-tramite", title: "Certificado de matrimonio para tramite", category: "Documentos", summary: "Prepara certificado para banco, beneficios, viajes, herencias o tramites familiares.", cost: "$0 a $1.500 aprox.", duration: "Inmediato online si esta disponible.", channel: "Registro Civil", documents: ["RUN", "ClaveUnica si aplica", "Finalidad"], sources: [registroCivil, chileAtiende] },
  { slug: "certificado-defuncion-para-herencia", title: "Certificado de defuncion para herencia", category: "Documentos", summary: "Obtiene respaldo para herencias, seguros, beneficios o gestiones familiares.", cost: "$0 a $1.500 aprox.", duration: "Inmediato online si esta disponible.", channel: "Registro Civil", documents: ["RUN fallecido", "Finalidad", "ClaveUnica si aplica"], sources: [registroCivil, chileAtiende] },
  ...
  { slug: "actualizar-tramo-fonasa", title: "Actualizar tramo Fonasa", category: "Salud", summary: "Prepara ingresos y cargas para revisar o corregir tramo de Fonasa.", cost: "$0 directo.", duration: "Minutos a dias.", channel: "Fonasa o ChileAtiende", documents: ["Cedula", "Ingresos", "Cargas"], sources: [chileAtiende] },
  ...
  { slug: "cobertura-ley-urgencia", title: "Revisar cobertura Ley de Urgencia", category: "Salud", summary: "Ordena antecedentes de atencion urgente para entender cobertura y cobros.", cost: "Copago o deuda variable segun cobertura.", duration: "Dias a semanas.", channel: "Prestador, Fonasa, Isapre o Superintendencia", documents: ["Epicrisis", "Boletas", "Datos cobertura"], sources: [chileAtiende] },
  ...
  { slug: "rut-empresa-para-operar", title: "Obtener RUT de empresa para operar", category: "Empresas", summary: "Prepara constitucion y datos del representante para operar con RUT empresarial.", cost: "$0 directo.", duration: "Minutos a dias.", channel: "SII", documents: ["Constitucion", "Representante", "Clave SII"], sources: [sii] },
...
const moreProcedureSeeds: ProcedureSeed[] = [
  // Autos
  { slug: "comprar-auto-usado", title: "Comprar un auto usado", category: "Autos", summary: "Ordena revision legal, mecanica, deudas y transferencia antes de pagar por un vehiculo usado.", cost: "$20.000 a $250.000+ aprox.", duration: "1 dia a 2 semanas segun revision y transferencia.", channel: "Registro Civil, notaria, vendedor y fuentes vehiculares", documents: ["Certificado anotaciones", "Revision tecnica", "Contrato o comprobante"], sources: [registroCivil, chileAtiende] },
  { slug: "vender-auto-con-prenda", title: "Vender auto con prenda o deuda", category: "Autos", summary: "Prepara alzamiento, saldo y autorizaciones antes de prometer una venta con financiamiento pendiente.", cost: "Deuda pendiente + $10.000 a $80.000+ aprox.", duration: "Dias a semanas segun acreedor.", channel: "Entidad financiera y Registro Civil", documents: ["Saldo deuda", "Certificado prenda", "Autorizacion acreedor"], sources: [registroCivil, chileAtiende] },
  { slug: "comprar-auto-en-remate", title: "Comprar auto en remate", category: "Autos", summary: "Revisa bases, estado registral, multas y costos antes de adjudicar un vehiculo.", cost: "Valor adjudicacion + comisiones y regularizaciones.", duration: "Dias a semanas.", channel: "Casa de remate, Registro Civil y municipalidad", documents: ["Bases remate", "Patente o VIN", "Comprobante adjudicacion"], sources: [registroCivil, municipalidades] },
  { slug: "importar-vehiculo", title: "Importar vehiculo a Chile", category: "Autos", summary: "Ordena aduana, homologacion, impuestos y registro antes de comprar un vehiculo fuera de Chile.", cost: "Variable por valor, impuestos, transporte y homologacion.", duration: "Semanas a meses.", channel: "Aduanas, importador y Registro Civil", documents: ["Factura exterior", "Documento aduanero", "Homologacion"], sources: [chileAtiende, registroCivil] },
  { slug: "regularizar-auto-herencia", title: "Regularizar auto recibido por herencia", category: "Autos", summary: "Prepara posesion efectiva, herederos y documentos del vehiculo antes de transferir o vender.", cost: "$0 a costos notariales/registro variables.", duration: "Semanas a meses.", channel: "Registro Civil y herederos", documents: ["Posesion efectiva", "Padron", "Acuerdo herederos"], sources: [registroCivil, chileAtiende] },
  { slug: "revisar-deuda-tag", title: "Revisar deuda TAG antes de vender", category: "Autos", summary: "Prepara consultas y comprobantes para evitar deudas de autopistas al comprar o vender.", cost: "Variable segun deuda.", duration: "15 minutos a varios dias.", channel: "Concesionarias de autopistas", documents: ["Patente", "RUT titular", "Comprobantes de pago"], sources: [chileAtiende] },
  { slug: "cambiar-propietario-por-remate", title: "Transferir vehiculo adjudicado en remate", category: "Autos", summary: "Ordena adjudicacion, impuestos y documentos registrales para inscribir el vehiculo rematado.", cost: "Impuestos + inscripcion variable.", duration: "Dias a semanas.", channel: "Registro Civil o canal autorizado", documents: ["Acta adjudicacion", "Cedula", "Datos vehiculo"], sources: [registroCivil, chileAtiende] },
  { slug: "solicitar-permiso-provisorio-vehiculo", title: "Solicitar permiso provisorio para vehiculo", category: "Autos", summary: "Prepara antecedentes para circular temporalmente cuando el caso lo permite.", cost: "$5.000 a $30.000 aprox.", duration: "Minutos a dias segun comuna.", channel: "Municipalidad", documents: ["Cedula", "Datos vehiculo", "Justificacion"], sources: [municipalidades] },
  { slug: "revisar-auto-antes-viaje", title: "Preparar auto antes de viaje largo", category: "Autos", summary: "Ordena documentos, seguridad, seguro y estado mecanico antes de salir de viaje.", cost: "$0 a $250.000+ aprox.", duration: "1 hora a varios dias.", channel: "Taller, aseguradora y documentos vehiculares", documents: ["Revision tecnica", "SOAP", "Permiso circulacion"], sources: [chileAtiende] },
  { slug: "regularizar-auto-siniestro", title: "Regularizar auto despues de siniestro", category: "Autos", summary: "Prepara denuncia, seguro, reparacion y documentos antes de volver a circular o vender.", cost: "Deducible y reparacion variable.", duration: "Dias a meses.", channel: "Aseguradora, taller y Registro Civil si aplica", documents: ["Denuncia o parte", "Poliza", "Informe taller"], sources: [chileAtiende] },

  // Vivienda
  { slug: "comprar-departamento-usado", title: "Comprar departamento usado", category: "Vivienda", summary: "Ordena deuda, gastos comunes, dominio y promesa antes de comprometer una compra.", cost: "Pie + gastos notariales, CBR y bancarios variables.", duration: "Semanas a meses.", channel: "Banco, notaria, CBR y vendedor", documents: ["Dominio vigente", "Gastos comunes", "Promesa"], sources: [chileAtiende] },
  { slug: "arrendar-departamento", title: "Arrendar departamento", category: "Vivienda", summary: "Revisa contrato, garantia, gastos comunes, reajustes y entrega antes de firmar arriendo.", cost: "Garantia 1 a 2 meses + mes de arriendo.", duration: "1 a 7 dias.", channel: "Arrendador, corredor o notaria", documents: ["Cedula", "Ingresos", "Contrato arriendo"], sources: [chileAtiende] },
  { slug: "entregar-departamento-arrendado", title: "Entregar departamento arrendado", category: "Vivienda", summary: "Prepara inventario, pagos, avisos y respaldo para recuperar garantia sin conflictos.", cost: "Variable por danos, deudas o multas.", duration: "Dias a semanas.", channel: "Arrendador, corredor o tribunal si hay conflicto", documents: ["Contrato", "Inventario", "Comprobantes pago"], sources: [chileAtiende] },
  { slug: "reclamar-gastos-comunes", title: "Revisar o reclamar gastos comunes", category: "Vivienda", summary: "Ordena cobros, reglamento y respaldos antes de reclamar gastos comunes.", cost: "Variable segun cobro.", duration: "Dias a semanas.", channel: "Administracion, comite o instancia legal", documents: ["Liquidacion gastos", "Reglamento", "Comprobantes"], sources: [chileAtiende] },
  { slug: "inscribir-propiedad-cbr", title: "Inscribir propiedad en Conservador", category: "Vivienda", summary: "Prepara escritura, impuestos y datos de inscripcion para registrar una propiedad.", cost: "$50.000 a $500.000+ aprox.", duration: "Dias a semanas.", channel: "Conservador de Bienes Raices", documents: ["Escritura", "Comprobante impuestos", "Datos comprador"], sources: [chileAtiende] },
  { slug: "recuperar-copia-escritura-propiedad", title: "Recuperar copia de escritura de propiedad", category: "Vivienda", summary: "Ubica notaria, repertorio y datos para recuperar una escritura de compraventa o hipoteca.", cost: "$5.000 a $50.000+ aprox.", duration: "Horas a dias.", channel: "Notaria o archivo correspondiente", documents: ["Datos notaria", "Fecha o repertorio", "Cedula"], sources: [chileAtiende] },
  { slug: "regularizar-deuda-contribuciones", title: "Regularizar deuda de contribuciones", category: "Vivienda", summary: "Revisa cuotas, intereses, convenios y rol antes de pagar o vender una propiedad.", cost: "Deuda + intereses variables.", duration: "Minutos a semanas si hay convenio.", channel: "Tesoreria General de la Republica", documents: ["Rol propiedad", "RUT", "Medio de pago"], sources: [chileAtiende] },
  ...
  { slug: "revisar-pago-pension-alimentos", title: "Revisar deuda de pension de alimentos", category: "Familia", summary: "Prepara liquidacion, pagos y antecedentes antes de pedir cumplimiento o medidas.", cost: "$0 a asesoria variable.", duration: "Dias a meses.", channel: "Tribunal de familia", documents: ["Resolucion", "Comprobantes pago", "Liquidacion deuda"], sources: [chileAtiende] },
  { slug: "pedir-mediacion-familiar", title: "Pedir hora de mediacion familiar", category: "Familia", summary: "Define tema, documentos y propuesta antes de asistir a mediacion.", cost: "$0 a tarifa variable segun centro.", duration: "Dias a semanas.", channel: "Centro de mediacion", documents: ["Cedula", "Certificados", "Propuesta acuerdo"], sources: [chileAtiende] },
  { slug: "preparar-divorcio-mutuo-acuerdo", title: "Preparar divorcio de mutuo acuerdo", category: "Familia", summary: "Ordena cese convivencia, acuerdos y documentos antes de iniciar divorcio.", cost: "$0 a asesoria/notaria variable.", duration: "Semanas a meses.", channel: "Tribunal o asesor legal", documents: ["Certificado matrimonio", "Cese convivencia", "Acuerdo completo"], sources: [chileAtiende, registroCivil] },
  { slug: "solicitar-adopcion-informacion", title: "Prepararse para proceso de adopcion", category: "Familia", summary: "Revisa requisitos, evaluaciones y documentos antes de iniciar un proceso de adopcion.", cost: "$0 a costos documentales/asesoria.", duration: "Meses a anos.", channel: "Mejor Ninez o tribunal segun etapa", documents: ["Cedula", "Antecedentes familiares", "Informes"], sources: [chileAtiende] },
  { slug: "cambiar-nombre-apellido", title: "Cambiar nombre o apellido", category: "Familia", summary: "Prepara causales, certificados y efectos antes de solicitar cambio registral.", cost: "$0 a asesoria variable.", duration: "Semanas a meses.", channel: "Registro Civil o tribunal segun caso", documents: ["Cedula", "Certificados", "Antecedentes de causal"], sources: [registroCivil, chileAtiende] },
  { slug: "reconocer-hijo", title: "Reconocimiento de hijo o hija", category: "Familia", summary: "Ordena identidad, certificados y consentimiento cuando corresponda antes del reconocimiento.", cost: "$0 a costos notariales variables.", duration: "Minutos a dias.", channel: "Registro Civil o notaria segun caso", documents: ["Cedula", "Certificado nacimiento", "Consentimiento si aplica"], sources: [registroCivil, chileAtiende] },
  { slug: "autorizar-tramite-menor", title: "Autorizar tramite de menor de edad", category: "Familia", summary: "Prepara permisos y certificados cuando un menor necesita firmar, viajar o gestionar un documento.", cost: "$0 a $30.000 aprox.", duration: "Horas a dias.", channel: "Notaria, Registro Civil o institucion solicitante", documents: ["Cedula adulto", "Certificado nacimiento", "Datos tramite"], sources: [registroCivil, chileAtiende] },
  { slug: "solicitar-beneficio-familiar", title: "Preparar postulacion a beneficio familiar", category: "Familia", summary: "Ordena RSH, ingresos, cargas y documentos antes de solicitar beneficios del hogar.", cost: "$0", duration: "Minutos a semanas.", channel: "ChileAtiende o entidad del beneficio", documents: ["RSH", "Cedula", "Ingresos o cargas"], sources: [chileAtiende] },
  { slug: "organizar-herencia-familiar", title: "Organizar antecedentes de herencia", category: "Familia", summary: "Prepara certificados, bienes, deudas y herederos antes de iniciar gestiones sucesorias.", cost: "$0 a asesoria variable.", duration: "Semanas a meses.", channel: "Registro Civil, CBR, bancos o tribunal", documents: ["Defuncion", "Herederos", "Inventario bienes"], sources: [registroCivil, chileAtiende] },

  // Trabajo
  { slug: "reclamar-cotizaciones-impagas", title: "Reclamar cotizaciones impagas", category: "Trabajo", summary: "Ordena certificados, liquidaciones y contrato antes de reclamar deuda previsional.", cost: "$0", duration: "Dias a semanas.", channel: "Direccion del Trabajo, AFP o entidad previsional", documents: ["Certificado cotizaciones", "Liquidaciones", "Contrato"], sources: [dt, chileAtiende] },
  { slug: "preparar-denuncia-acoso-laboral", title: "Preparar denuncia por acoso laboral", category: "Trabajo", summary: "Ordena hechos, fechas, pruebas y canales antes de denunciar hostigamiento o maltrato.", cost: "$0 a asesoria variable.", duration: "Dias a meses.", channel: "Empleador, DT o tribunal segun caso", documents: ["Relato cronologico", "Pruebas", "Contrato"], sources: [dt, chileAtiende] },
  { slug: "revisar-despido", title: "Revisar carta de despido", category: "Trabajo", summary: "Analiza causal, fecha, pagos y respaldos antes de firmar finiquito o reclamar.", cost: "$0 a asesoria variable.", duration: "Horas a semanas.", channel: "Empleador, DT o asesor laboral", documents: ["Carta despido", "Contrato", "Liquidaciones"], sources: [dt] },
  { slug: "pedir-certificado-antiguedad-laboral", title: "Pedir certificado de antiguedad laboral", category: "Trabajo", summary: "Prepara solicitud y datos del empleador para acreditar relacion laboral.", cost: "$0", duration: "Horas a dias.", channel: "Empleador o DT segun disponibilidad", documents: ["Contrato", "Datos empleador", "Cedula"], sources: [dt, chileAtiende] },
  { slug: "preparar-renuncia-voluntaria", title: "Preparar renuncia voluntaria", category: "Trabajo", summary: "Ordena plazos, carta, firma y respaldos antes de renunciar.", cost: "$0 a notaria variable.", duration: "Horas a dias.", channel: "Empleador, DT o notaria", documents: ["Carta renuncia", "Cedula", "Contrato"], sources: [dt] },
  { slug: "revisar-anexo-laboral", title: "Revisar anexo laboral", category: "Trabajo", summary: "Confirma cambios de sueldo, jornada, funciones o lugar antes de firmar un anexo.", cost: "$0 a asesoria variable.", duration: "30 minutos a dias.", channel: "Empleador o DT si hay duda", documents: ["Anexo", "Contrato original", "Liquidaciones"], sources: [dt] },
  { slug: "solicitar-teletrabajo", title: "Solicitar o revisar teletrabajo", category: "Trabajo", summary: "Prepara acuerdo, jornada, equipos y seguridad antes de pactar trabajo remoto.", cost: "$0 directo.", duration: "Dias segun empleador.", channel: "Empleador", documents: ["Solicitud", "Contrato o anexo", "Condiciones de trabajo"], sources: [dt] },
  { slug: "reclamar-sueldo-impago", title: "Reclamar sueldo impago", category: "Trabajo", summary: "Ordena contrato, liquidaciones, asistencia y comunicaciones antes de reclamar remuneraciones.", cost: "$0", duration: "Dias a semanas.", channel: "Direccion del Trabajo o tribunal", documents: ["Contrato", "Liquidaciones", "Mensajes o asistencia"], sources: [dt] },
  { slug: "preparar-licencia-medica-trabajo", title: "Preparar licencia medica laboral", category: "Trabajo", summary: "Revisa empleador, plazos y comprobantes antes de tramitar una licencia medica.", cost: "$0 directo.", duration: "Dias a semanas.", channel: "Empleador, COMPIN o Isapre", documents: ["Licencia", "Cedula", "Datos empleador"], sources: [chileAtiende, dt] },
  { slug: "revisar-jornada-horas-extra", title: "Revisar jornada y horas extra", category: "Trabajo", summary: "Ordena turnos, asistencia y pagos antes de reclamar horas extra o jornada incorrecta.", cost: "$0 a asesoria variable.", duration: "Horas a semanas.", channel: "Empleador o Direccion del Trabajo", documents: ["Registro asistencia", "Liquidaciones", "Contrato"], sources: [dt] },

  // Impuestos
  { slug: "preparar-operacion-renta", title: "Preparar Operacion Renta", category: "Impuestos", summary: "Ordena ingresos, retenciones, inversiones y observaciones antes de declarar renta.", cost: "$0 a gestion contable variable.", duration: "30 minutos a varios dias.", channel: "SII", documents: ["Clave SII", "Ingresos", "Retenciones"], sources: [sii] },
  { slug: "revisar-propuesta-renta", title: "Revisar propuesta de renta del SII", category: "Impuestos", summary: "Compara datos propuestos con respaldos antes de aceptar la declaracion anual.", cost: "Impuesto o devolucion variable.", duration: "30 minutos a horas.", channel: "SII", documents: ["Propuesta", "Certificados", "Respaldos"], sources: [sii] },
  { slug: "declarar-arriendo", title: "Declarar ingresos por arriendo", category: "Impuestos", summary: "Ordena contratos, pagos y gastos antes de declarar ingresos por arriendo.", cost: "Impuesto variable segun caso.", duration: "Horas a dias.", channel: "SII o contador", documents: ["Contrato arriendo", "Pagos recibidos", "Gastos respaldados"], sources: [sii] },
  { slug: "emitir-nota-credito", title: "Emitir nota de credito", category: "Impuestos", summary: "Prepara factura original, motivo y datos antes de corregir una venta.", cost: "$0 directo.", duration: "5 a 30 minutos.", channel: "SII o software autorizado", documents: ["Factura original", "Motivo correccion", "Clave SII"], sources: [sii] },
  { slug: "anular-boleta-honorarios-emitida", title: "Anular boleta de honorarios emitida", category: "Impuestos", summary: "Revisa receptor, motivo y plazo antes de anular o corregir una boleta.", cost: "$0 directo.", duration: "5 a 30 minutos.", channel: "SII", documents: ["Boleta emitida", "Motivo anulacion", "Clave SII"], sources: [sii] },
  { slug: "solicitar-devolucion-impuestos-anual", title: "Solicitar o revisar devolucion anual de impuestos", category: "Impuestos", summary: "Prepara cuenta bancaria, declaracion y observaciones antes de esperar devolucion.", cost: "$0 directo.", duration: "Dias a semanas.", channel: "SII y Tesoreria", documents: ["Declaracion renta", "Cuenta bancaria", "Observaciones"], sources: [sii, chileAtiende] },
  { slug: "pagar-ppm", title: "Revisar pagos provisionales mensuales", category: "Impuestos", summary: "Ordena ventas, tasa y flujo de caja antes de pagar PPM.", cost: "Variable segun ingresos.", duration: "15 minutos a horas.", channel: "SII", documents: ["Ventas", "F29", "Clave SII"], sources: [sii] },
  { slug: "pedir-carpeta-tributaria", title: "Obtener carpeta tributaria", category: "Impuestos", summary: "Prepara carpeta tributaria para banco, arriendo, licitacion o proveedor.", cost: "$0", duration: "Minutos online.", channel: "SII", documents: ["Clave SII", "Finalidad", "Correo destino si aplica"], sources: [sii] },
  { slug: "revisar-observaciones-sii", title: "Revisar observaciones del SII", category: "Impuestos", summary: "Ordena diferencias, documentos y plazos antes de responder observaciones.", cost: "Variable por diferencias o multas.", duration: "Horas a semanas.", channel: "SII", documents: ["Observacion", "Respaldos", "Declaraciones"], sources: [sii] },
  { slug: "preparar-inicio-actividades-profesional", title: "Inicio de actividades profesional independiente", category: "Impuestos", summary: "Define giro, domicilio y boletas antes de comenzar a emitir honorarios.", cost: "$0 directo.", duration: "15 minutos a dias.", channel: "SII", documents: ["Clave SII", "Domicilio", "Giro"], sources: [sii] },

  // Viajes
  { slug: "renovar-pasaporte-viaje-proximo", title: "Renovar pasaporte con viaje proximo", category: "Viajes", summary: "Revisa citas, vigencia y alternativas cuando el viaje depende del pasaporte.", cost: "$69.000+ aprox.", duration: "Dias habiles segun agenda.", channel: "Registro Civil", documents: ["Cedula", "Pasaporte anterior", "Itinerario"], sources: [registroCivil, chileAtiende] },
  { slug: "viajar-con-menor-sin-un-padre", title: "Viajar con menor sin uno de los padres", category: "Viajes", summary: "Prepara autorizacion, certificados y datos de viaje para evitar problemas en salida.", cost: "$5.000 a $40.000+ aprox.", duration: "Horas a dias.", channel: "Notaria, tribunal o PDI", documents: ["Certificado nacimiento", "Autorizacion", "Pasaporte o cedula"], sources: [chileAtiende] },
  { slug: "preparar-visa-estudiante", title: "Preparar visa de estudiante", category: "Viajes", summary: "Ordena pasaporte, aceptacion, solvencia y documentos del destino antes de solicitar visa.", cost: "Variable por pais y traducciones.", duration: "Semanas a meses.", channel: "Consulado o portal oficial del pais", documents: ["Pasaporte", "Carta aceptacion", "Solvencia"], sources: [chileAtiende] },
  { slug: "preparar-visa-trabajo", title: "Preparar visa de trabajo", category: "Viajes", summary: "Revisa contrato, antecedentes y requisitos consulares antes de aceptar fechas de viaje.", cost: "Variable por pais.", duration: "Semanas a meses.", channel: "Consulado o portal oficial del pais", documents: ["Pasaporte", "Contrato/oferta", "Antecedentes"], sources: [chileAtiende] },
  { slug: "viajar-con-medicamentos", title: "Viajar con medicamentos", category: "Viajes", summary: "Ordena receta, certificados y normas del destino antes de transportar medicamentos.", cost: "$0 a costos medicos/documentales.", duration: "Dias a semanas.", channel: "Medico, aerolinea y autoridad destino", documents: ["Receta", "Informe medico", "Pasaporte"], sources: [chileAtiende] },
  { slug: "preparar-documentos-consulado", title: "Preparar atencion en consulado", category: "Viajes", summary: "Ordena documentos, cita y pagos antes de realizar gestiones consulares.", cost: "Variable por tramite consular.", duration: "Dias a semanas.", channel: "Consulado correspondiente", documents: ["Pasaporte", "Formulario", "Comprobante cita"], sources: [chileAtiende] },
  { slug: "perdida-documentos-en-viaje", title: "Que hacer si pierdes documentos en el extranjero", category: "Viajes", summary: "Prepara denuncia, contacto consular y respaldos para obtener asistencia o documento temporal.", cost: "Variable por consulado y traslados.", duration: "Horas a dias.", channel: "Consulado chileno y policia local", documents: ["Denuncia", "Copia documentos", "Itinerario"], sources: [chileAtiende] },
  { slug: "preparar-viaje-mascota-retorno", title: "Preparar retorno a Chile con mascota", category: "Viajes", summary: "Revisa certificados sanitarios, vacunas y plazos antes de volver con mascota.", cost: "$20.000 a $250.000+ aprox.", duration: "Dias a semanas.", channel: "SAG, veterinario y aerolinea", documents: ["Certificado sanitario", "Vacunas", "Datos mascota"], sources: [chileAtiende] },
  { slug: "revisar-restricciones-aduana", title: "Revisar restricciones de Aduana antes de viajar", category: "Viajes", summary: "Ordena boletas y declara productos cuando corresponda para evitar multas o retenciones.", cost: "Variable por impuestos o sanciones.", duration: "Minutos a horas.", channel: "Aduanas", documents: ["Boletas", "Declaracion", "Pasaporte"], sources: [chileAtiende] },
  { slug: "preparar-viaje-adulto-mayor", title: "Preparar viaje de adulto mayor", category: "Viajes", summary: "Revisa salud, seguros, documentos, medicamentos y asistencia antes de viajar.", cost: "$0 a seguro/atencion variable.", duration: "Dias a semanas.", channel: "Registro Civil, aseguradora, medico y aerolinea", documents: ["Cedula o pasaporte", "Seguro", "Recetas"], sources: [chileAtiende] },

  // Documentos
  { slug: "apostillar-certificado-nacimiento", title: "Apostillar certificado de nacimiento", category: "Documentos", summary: "Prepara certificado correcto y pais de destino antes de apostillar.", cost: "$0 a costos de certificado.", duration: "Minutos a dias.", channel: "Apostilla Chile o entidad emisora", documents: ["Certificado nacimiento", "Pais destino", "ClaveUnica"], sources: [chileAtiende, registroCivil] },
  { slug: "apostillar-certificado-estudios", title: "Apostillar certificado de estudios", category: "Documentos", summary: "Ordena certificado, validacion y destino antes de usar estudios fuera de Chile.", cost: "$0 a costos documentales.", duration: "Dias a semanas.", channel: "MINEDUC y Apostilla Chile", documents: ["Certificado estudios", "Pais destino", "Datos solicitante"], sources: [chileAtiende] },
  { slug: "legalizar-documento-notarial", title: "Legalizar documento notarial", category: "Documentos", summary: "Revisa firmas, notaria y finalidad antes de presentar documentos legalizados.", cost: "$5.000 a $40.000+ aprox.", duration: "Horas a dias.", channel: "Notaria o entidad que legaliza", documents: ["Documento original", "Cedula", "Finalidad"], sources: [chileAtiende] },
  { slug: "pedir-certificado-antecedentes", title: "Certificado de antecedentes", category: "Documentos", summary: "Prepara certificado correcto para trabajo, visa, estudio o institucion solicitante.", cost: "$0 a $1.500 aprox.", duration: "Inmediato online.", channel: "Registro Civil", documents: ["RUN", "ClaveUnica", "Finalidad"], sources: [registroCivil, chileAtiende] },
  { slug: "pedir-certificado-inhabilidades", title: "Certificado de inhabilidades", category: "Documentos", summary: "Revisa si necesitas certificado para trabajar con menores u otros fines sensibles.", cost: "$0 a $1.500 aprox.", duration: "Inmediato online.", channel: "Registro Civil", documents: ["RUN", "Finalidad", "ClaveUnica"], sources: [registroCivil, chileAtiende] },
  { slug: "pedir-certificado-rsh", title: "Cartola Registro Social de Hogares", category: "Documentos", summary: "Prepara cartola y datos del hogar antes de postular a beneficios.", cost: "$0", duration: "Minutos online.", channel: "Registro Social de Hogares", documents: ["ClaveUnica", "Datos hogar", "Finalidad"], sources: [chileAtiende] },
  { slug: "actualizar-datos-registro-civil", title: "Actualizar datos en Registro Civil", category: "Documentos", summary: "Ordena certificados y respaldo cuando un dato personal aparece incorrecto.", cost: "$0 a costos documentales.", duration: "Dias a semanas.", channel: "Registro Civil", documents: ["Cedula", "Certificado con error", "Respaldo"], sources: [registroCivil] },
  { slug: "pedir-certificado-militar", title: "Certificado de situacion militar", category: "Documentos", summary: "Prepara datos para acreditar situacion militar cuando una institucion lo solicita.", cost: "$0 a $3.000 aprox.", duration: "Minutos a dias.", channel: "Canton de reclutamiento o ChileAtiende", documents: ["RUN", "Cedula", "Finalidad"], sources: [chileAtiende] },
  { slug: "obtener-claveunica", title: "Obtener o recuperar ClaveUnica", category: "Documentos", summary: "Prepara identidad y canal para obtener acceso a tramites digitales.", cost: "$0", duration: "Minutos a dias.", channel: "Registro Civil o ChileAtiende", documents: ["Cedula", "Correo", "Telefono"], sources: [registroCivil, chileAtiende] },
  { slug: "preparar-documentos-banco", title: "Preparar documentos para banco", category: "Documentos", summary: "Ordena identidad, ingresos, domicilio y certificados antes de solicitar productos bancarios.", cost: "$0 a costos documentales.", duration: "Horas a dias.", channel: "Banco o institucion financiera", documents: ["Cedula", "Ingresos", "Domicilio"], sources: [chileAtiende] },

  // Salud
  { slug: "apelar-licencia-medica-rechazada", title: "Apelar licencia medica rechazada", category: "Salud", summary: "Ordena resolucion, informes y plazos antes de apelar una licencia rechazada o reducida.", cost: "$0 a informes medicos variables.", duration: "Dias a semanas.", channel: "COMPIN, Isapre o Superintendencia", documents: ["Resolucion", "Informe medico", "Licencia"], sources: [chileAtiende] },
  { slug: "preparar-reclamo-fonasa", title: "Preparar reclamo en Fonasa", category: "Salud", summary: "Ordena bonos, boletas y respuestas antes de reclamar cobertura o atencion.", cost: "$0", duration: "Dias a semanas.", channel: "Fonasa o ChileAtiende", documents: ["Cedula", "Bono o boleta", "Respuesta previa"], sources: [chileAtiende] },
  { slug: "preparar-reclamo-isapre", title: "Preparar reclamo en Isapre", category: "Salud", summary: "Reune contrato, plan, boletas y respuesta para reclamar cobertura o reembolso.", cost: "$0 a asesoria variable.", duration: "Dias a semanas.", channel: "Isapre o Superintendencia de Salud", documents: ["Plan salud", "Boletas", "Respuesta Isapre"], sources: [chileAtiende] },
  { slug: "revisar-cobertura-ley-urgencia", title: "Revisar cobertura Ley de Urgencia", category: "Salud", summary: "Ordena antecedentes de atencion y cobertura cuando hubo riesgo vital o secuela funcional grave.", cost: "Copagos o cobertura variable.", duration: "Dias a semanas.", channel: "Prestador, Fonasa/Isapre y Superintendencia", documents: ["Epicrisis", "Boletas", "Diagnostico"], sources: [chileAtiende] },
  { slug: "preparar-ges-salud-mental", title: "Preparar atencion GES de salud mental", category: "Salud", summary: "Revisa diagnostico, derivacion, plazos y prestador cuando una patologia puede estar cubierta.", cost: "Copago variable segun prevision.", duration: "Dias a semanas.", channel: "Fonasa, Isapre o prestador", documents: ["Diagnostico", "Derivacion", "Cedula"], sources: [chileAtiende] },
  { slug: "pedir-ficha-clinica", title: "Solicitar copia de ficha clinica", category: "Salud", summary: "Prepara identidad, autorizacion y datos del prestador para pedir antecedentes medicos.", cost: "$0 a costos de copia variables.", duration: "Dias a semanas.", channel: "Prestador de salud", documents: ["Cedula", "Solicitud", "Autorizacion si aplica"], sources: [chileAtiende] },
  { slug: "reembolsar-gastos-medicos", title: "Reembolsar gastos medicos", category: "Salud", summary: "Ordena boletas, ordenes, bonos y cuenta bancaria antes de pedir reembolso.", cost: "$0 directo; reembolso variable.", duration: "Dias a semanas.", channel: "Isapre, seguro o prestador", documents: ["Boletas", "Orden medica", "Cuenta bancaria"], sources: [chileAtiende] },
  { slug: "inscribir-recien-nacido-salud", title: "Incorporar recien nacido a salud", category: "Salud", summary: "Prepara certificado, cargas y prevision para incorporar a un recien nacido.", cost: "$0 directo.", duration: "Dias a semanas.", channel: "Fonasa, Isapre o caja", documents: ["Certificado nacimiento", "Cedula representante", "Datos prevision"], sources: [chileAtiende] },
  { slug: "actualizar-clasificacion-fonasa", title: "Actualizar clasificacion Fonasa", category: "Salud", summary: "Ordena ingresos, cargas y antecedentes para revisar tramo o clasificacion.", cost: "$0", duration: "Minutos a dias.", channel: "Fonasa o ChileAtiende", documents: ["Cedula", "Ingresos", "Cargas"], sources: [chileAtiende] },
  { slug: "preparar-cirugia-programada", title: "Preparar cirugia programada", category: "Salud", summary: "Ordena orden medica, presupuesto, cobertura y examenes antes de una cirugia.", cost: "Copago o presupuesto variable.", duration: "Dias a meses.", channel: "Prestador, Fonasa/Isapre o seguro", documents: ["Orden medica", "Presupuesto", "Examenes"], sources: [chileAtiende] },

  // Empresas
  { slug: "crear-spa-unipersonal", title: "Crear SpA unipersonal", category: "Empresas", summary: "Define giro, domicilio, capital y firma antes de crear una SpA con un solo accionista.", cost: "$0 a $120.000+ aprox.", duration: "1 dia a 2 semanas.", channel: "Empresa en un Dia, SII y municipalidad", documents: ["Cedula", "Giro", "Domicilio"], sources: [chileAtiende, sii] },
  { slug: "preparar-pacto-socios", title: "Preparar pacto de socios", category: "Empresas", summary: "Ordena aportes, roles, salida y decisiones antes de operar con socios.", cost: "$0 a asesoria legal variable.", duration: "Dias a semanas.", channel: "Socios, abogado o notaria", documents: ["Acuerdo socios", "Capital", "Roles"], sources: [chileAtiende] },
  { slug: "cambiar-giro-empresa", title: "Cambiar o ampliar giro de empresa", category: "Empresas", summary: "Revisa actividad real, SII, patente y permisos antes de modificar giro.", cost: "$0 a costos municipales variables.", duration: "Minutos a semanas.", channel: "SII y municipalidad", documents: ["Clave SII", "Giro nuevo", "Patente"], sources: [sii, municipalidades] },
  { slug: "cambiar-domicilio-empresa", title: "Cambiar domicilio de empresa", category: "Empresas", summary: "Prepara contrato, autorizacion y efectos municipales antes de cambiar domicilio.", cost: "$0 a costos notariales/municipales.", duration: "Dias a semanas.", channel: "SII, municipalidad y registro societario si aplica", documents: ["Domicilio nuevo", "Contrato", "Clave SII"], sources: [sii, municipalidades] },
  { slug: "cerrar-inicio-actividades", title: "Cerrar actividad tributaria de empresa", category: "Empresas", summary: "Ordena declaraciones, deudas, documentos y socios antes de cerrar actividad.", cost: "Impuestos/deudas pendientes variables.", duration: "Dias a meses.", channel: "SII y asesoria contable si aplica", documents: ["Declaraciones", "Deudas", "Clave SII"], sources: [sii] },
  { slug: "preparar-licitacion-publica", title: "Preparar postulacion a licitacion publica", category: "Empresas", summary: "Ordena antecedentes legales, tributarios, oferta y garantias antes de ofertar.", cost: "$0 a garantias/costos documentales.", duration: "Dias a semanas.", channel: "Mercado Publico", documents: ["Bases", "Oferta", "Antecedentes empresa"], sources: [chileAtiende, sii] },
  { slug: "registrar-dominio-web-empresa", title: "Preparar dominio web de empresa", category: "Empresas", summary: "Revisa marca, titularidad, correo y datos antes de registrar dominio comercial.", cost: "$10.000 a $50.000+ anual aprox.", duration: "Minutos a dias.", channel: "NIC o proveedor de dominios", documents: ["Nombre marca", "Datos titular", "Medio pago"], sources: [chileAtiende] },
  { slug: "preparar-contrato-servicios", title: "Preparar contrato de servicios", category: "Empresas", summary: "Define alcance, pagos, entregables, multas y propiedad antes de contratar o vender servicios.", cost: "$0 a asesoria legal variable.", duration: "Horas a dias.", channel: "Partes, abogado o notaria si aplica", documents: ["Propuesta", "Datos partes", "Condiciones pago"], sources: [chileAtiende] },
  { slug: "implementar-libro-remuneraciones", title: "Preparar libro de remuneraciones", category: "Empresas", summary: "Ordena trabajadores, sueldos, cotizaciones y respaldo antes de gestionar remuneraciones.", cost: "Software o gestion mensual variable.", duration: "Dias.", channel: "Empleador, DT y Previred", documents: ["Contratos", "Sueldos", "Cotizaciones"], sources: [dt, sii] },
  { slug: "preparar-aumento-capital", title: "Preparar aumento de capital", category: "Empresas", summary: "Ordena acuerdo, aportes, valorizacion y efectos societarios antes de aumentar capital.", cost: "$30.000 a asesoria variable.", duration: "Dias a semanas.", channel: "Socios, registro societario o notaria", documents: ["Acuerdo socios", "Aportes", "Estatutos"], sources: [chileAtiende, sii] }
];

type GeneratedGuideSeed = {
  procedure: ProcedureSeed;
  angle: string;
};
...
function makeGuideFromProcedureSeed({ procedure, angle }: GeneratedGuideSeed): GuideDetail {
  ...
  return {
    ...
    title: `Guia rapida: ${procedure.title}`,
    category: procedure.category,
    summary: `${angle} Usa esta guia para preparar documentos, costos, riesgos y siguiente accion antes de continuar fuera de ChileHub.`,
    updatedAt: "29 junio 2026",
    readingTime: "5 min",
    keyTakeaways: [
      `El canal principal para continuar suele ser ${procedure.channel}.`,
      `Costo referencial a preparar: ${procedure.cost}.`,
      `Plazo referencial: ${procedure.duration}.`
    ],
    decisionCards: [
      {
      ...
      },
      {
        ...
        detail: "Rango referencial para prepararte. Confirma el valor vigente antes de pagar."
      },
      {
        label: "Canal",
        value: primarySource.label,
    ...
    commonMistakes: [
      "Avanzar con documentos vencidos, incompletos o con datos que no coinciden.",
      "Tomar el costo referencial como monto definitivo.",
      "No confirmar si el caso cambia por comuna, institucion, fecha o perfil.",
      "No guardar comprobantes al continuar fuera de ChileHub."
    ],
    whenToGetHelp: [
      "Hay deuda, rechazo, plazo vencido, conflicto o dinero relevante.",
      "No sabes que institucion debe responder por tu caso.",
      "El documento se usara para firmar, vender, viajar, cobrar o reclamar."
    ],
    sections: [
      {
      ...
      {
        title: "Costo y plazo",
        body: `Considera ${procedure.cost} y ${procedure.duration} como referencias para organizarte, no como valores oficiales definitivos.`
      },
      {
        title: "Donde continuar",
        body: `Cuando tengas claridad, continua en ${procedure.channel}. ChileHub no ejecuta el tramite ni cobra por prepararte.`
      }
    ],
    checklist: [
    ...
    relatedProcedureSlug: procedure.slug,
